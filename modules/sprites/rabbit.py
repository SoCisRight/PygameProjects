...
class Rabbit(pygame.sprite.Sprite):
    def __init__(self, imagepaths, position=(40, 405), size=[(80, 80), (59, 47)], **kwargs):
        pygame.sprite.Sprite.__init__(self)
        # 导入所有图片
        self.images = []
        image = pygame.image.load(imagepaths[0])
        for i in range(9):
            self.images.append(pygame.transform.scale(image.subsurface((i*2624, 0), (2624, 1900)),  size[0]))
